// =============================================
// FORM DE CADASTRO SIMPLIFICADO
// Arquivo: FormCadastroCliente.cs
// =============================================
using System;
...
public partial class FormCadastroCliente : Form
{
    ...
    private void InitializeComponent()
    {
        ...
        panelForm.Controls.AddRange(new Control[] {
            lblNome, txtNome,
            lblCPF, txtCPF, lblDicaCPF,
            lblDataNasc, dtpDataNasc,
            lblEndereco, txtEndereco,
            lblCidade, txtCidade,
            lblINSS, txtINSS, lblDicaINSS
        });
        ...
        this.Controls.AddRange(new Control[] {
            lblTitulo, panelForm, btnSalvar, btnCancelar
        });
    }
